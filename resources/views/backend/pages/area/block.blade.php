    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title mb-3">Blocks</h3>
                        ...
                        <table id="table_id" class="display">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->subd}}</td>
                                    <td>
                                        <a data-district='[{{$item->id}},"{{$item->name}}","{{$item->sub_division_id}}"]' class="btn btn-primary btn-sm edit-btn" title="edit">E</a>
                                        <a href="{{url('delete-block/'.encrypt($item->id))}}" onclick="return confirm('Are you sure to delete this data ?')" class="btn btn-danger btn-sm" title="delete">D</a>
                                    </td>
                                </tr>
                                @endforeach   
                            </tbody>
