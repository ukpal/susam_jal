        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"> New Application
                  ...
                  @endif
                    <a href="{{url('leave-applications')}}" class="float-end btn btn-secondary">Back</a>
                </h5>
            </div>
            ...
            <div class="card-body">
              ...
              <form action="{{url('new-leave-application')}}" method="post" class="needs-validation" novalidate>
                @csrf                                      
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Submit</button>
                <a href="{{url('leave-applications')}}" class="btn btn-secondary">Cancel</a>
              </form> 
