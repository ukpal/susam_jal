            ...
            <div class="card-body">
                <form >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" readonly class="form-control"  name="ward_number" value="{{$response->ward_number}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Location/Market Name:</label>
                        <input type="text" readonly class="form-control"  name="location_name" value="{{$response->location_name}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Business/Institution Name:</label>
                        <input type="text" readonly class="form-control"  name="business_name" value="{{$response->business_name}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Business owner/Head of institution name:</label>
                        <input type="text" readonly class="form-control"  name="business_owner" value="{{$response->business_owner}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" readonly class="form-control"  name="short_address" value="{{$response->short_address}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="nature_of_business" disabled>
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="type_of_business" disabled>
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" readonly class="form-control" pattern="^[0-9]*"  name="total_employee" value="{{$response->total_employee}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="retrofitting_toilet" disabled>
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" readonly class="form-control" pattern="^[0-9]*"  name="generated_waste" value="{{$response->generated_waste}}">
                    </div>

                    <div class="mb-3">
                        <label  class="form-label">Vegetable Waste: </label>
                        <select class="form-select" name="vegetable_waste" disabled>
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="fish_waste" disabled>
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="meat_waste" disabled>
                            <option selected value="null">--- select ---</option>
                            @foreach (wasteMeasureTwo() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="present_waste_practices" disabled>
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="municipality_waste_bin" disabled>
                            <option selected value="null">--- select ---</option>
                            @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="it_is_adequate" disabled>
                            <option selected value="null">--- select ---</option>
                            @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="dustbin_available" disabled>
                            <option selected value="null">--- select ---</option>
                            @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="willing_to_pay_for_taking_waste" disabled>
                            <option selected value="null">--- select ---</option>
                            @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="waste_collection_time" disabled>
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="carry_bag_used" disabled>
                            <option selected value="null">--- select ---</option>
                            @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="can_give_money_for_carry" disabled>
                            <option selected value="null">--- select ---</option>
                            @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" readonly class="form-control" id="lat" name="latitude" value="{{$response->latitude}}" readonly>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Longitude:</label>
                        <input type="text" readonly class="form-control" id="long" name="longitude" value="{{$response->longitude}}" readonly>
                    </div>
