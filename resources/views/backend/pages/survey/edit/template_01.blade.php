            ...
            <div class="card-body">
                <form action="{{url('edit-response')}}" method="post" enctype="multipart/form-data" name="myForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="ward_no" value="{{$response->ward_no}}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Head of the family name:</label>
                        <input type="text"  class="form-control" name="head_of_family" value="{{$response->head_of_family}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Fathers' name:</label>
                        <input type="text"  class="form-control" name="father_name" value="{{$response->father_name}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Husbands' name:</label>
                        <input type="text"  class="form-control" name="husband_name" value="{{$response->husband_name}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="nature_of_resident" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  class="form-control" name="holding_number" value="{{$response->holding_number}}">
                    </div>

                    <div class="mb-3">
                        <label  class="form-label">Permanent resident:</label>
                        <select class="form-select" name="permanent_resident" >
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  class="form-control" name="other_type_resident" value="{{$response->other_type_resident}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">No. of family members:</label>
                        <input type="text"  class="form-control" name="family_members" value="{{$response->family_members}}">
                    </div>

                    <div class="mb-3">
                        <label  class="form-label">Only Old Age Family:</label>
                        <select class="form-select" name="old_age_family" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="building_category" >
                            <option selected value="null">--- select ---</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date"  class="form-control" name="septic_tank_cleaning_year" value="{{$response->septic_tank_cleaning_year}}">
                    </div>

                    <div class="mb-3">
                        <label  class="form-label">If there have septic tank with sock pit:</label>
                        <select class="form-select" name="septic_tank_with_sock_pit" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="water_connection" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="bulk_waste_generator" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="waster_bin_received" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time"  class="form-control" name="waste_collection_time" value="{{$response->waste_collection_time}}">
                    </div>

                    <div class="mb-3">
                        <label  class="form-label">Present waste collection system is in there? </label>
                        <select class="form-select" name="present_waste_collection" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  class="form-control" pattern="^[0-9]*" placeholder="in Kg." name="wet_waste_generation" value="{{$response->wet_waste_generation}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Approx Bio-Degradable (Dry) waste generation:</label>
                        <input type="text"  class="form-control" pattern="^[0-9]*" placeholder="in Kg." name="dry_waste_generation" value="{{$response->dry_waste_generation}}">
                    </div>

                    <div class="mb-3">
                        <label  class="form-label">Any scope of bio-medical waste generation? </label>
                        <select class="form-select" name="bio_medical_waste_scope" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="residence_of_commercial" >
                            <option selected value="null">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="orient_on_municipal_waste_collection" >
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="orient_on_source_segregation" >
                            <option selected value="">--- select ---</option>
                          @foreach (yesNoNotApplicable() as $key=>$value)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name_of_assign"  value="{{$response->name_of_assign}}">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Other Comments:</label>
                        <textarea name="other_comments"  class="form-control" cols="30" rows="5">{{$response->other_comments}}</textarea>
                    </div>
                    ...
                    <input type="hidden" name="survey_id" value="{{$response->survey_id}}">
